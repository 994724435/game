    ...
    <div id="base" class="">
      ...
      <div id="u18" class="ax_default">
          ...
          <div id="u20" class="ax_default box_1">
            <div id="u20_div" class="">
									<div style="width: 100%;margin-top: 39px;">
									  <table>
										 	<?php if(is_array($product)): foreach($product as $key=>$val): ?><tr style="text-align: center;"><td width="281px"><?php echo ($val['name']); ?></td><td width="155px"><?php echo ($val['time']); ?>小时</td><td width="238px"><?php echo ($val['admin']); ?></td><td width="224px"><?php echo ($val['start']); ?>  |  <a href="__ROOT__/index.php/Index/buy/id/<?php echo ($val["id"]); ?>">购买</a></td></tr><?php endforeach; endif; ?>   
										 </table>
									</div>
            </div>
            <!-- Unnamed () -->
        ...
        <div id="u77" class="ax_default text_field">
          <input id="u77_input" type="number" value=""/>
        </div>

        <!-- Unnamed (提交按钮) -->
        <div id="u78" class="ax_default html_button">
          <a href=""><input id="u78_input" type="submit" value="竞标"/></a>
      ...
      <div id="u129" class="ax_default ax_default_hidden">
        ...
        <div id="u130" class="ax_default box_1">
          <div id="u130_div" class="">
          	<div style="width: 100%;margin-top: 39px;">
									  <table>
										 	<?php if(is_array($mine)): foreach($mine as $key=>$val): ?><tr style="text-align: center;"><td width="331px"><?php echo ($val['name']); ?></td><td width="185px"><?php echo ($val['time']); ?>小时</td><td width="283px"><?php echo ($val['admin']); ?></td><td width="266px"><?php echo ($val['start']); ?> </td></tr><?php endforeach; endif; ?>   
										 </table>
									</div>
          </div>
          <!-- Unnamed () -->
